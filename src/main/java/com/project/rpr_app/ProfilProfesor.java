...
public class ProfilProfesor extends AppCompatActivity {
    private Button RecenzieProf;
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecenzieProf = findViewById(R.id.Recenzie);



        RecenzieProf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                moveTo(Pagina_Adauga_Recenzie.class);
            }
        });
    ...
    {
        Intent intent = new Intent(ProfilProfesor.this,state);
